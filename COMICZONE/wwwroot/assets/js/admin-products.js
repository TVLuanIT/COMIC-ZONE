/**
 * admin-products.js
 * Product management logic: Badges, Image Uploads, Product Index AJAX.
 */
...
const BadgeSelect = () => {
    ...
    const initRemove = () => {
        document.addEventListener("click", function (e) {
            if (e.target.classList.contains("remove-artist") || e.target.classList.contains("remove-tag")) {
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (isDeleted) {
                            ...
                            statusCell.html('<span class="badge bg-danger">Ngừng kinh doanh</span>');
                            ...
                            statusCell.html('<span class="badge bg-success">Đang bán</span>');
