...
namespace COMICZONE.Services
{
    public sealed class PaypalClient
    {
        ...
        private async Task<AuthResponse> Authenticate()
        {
            ...
            {
                throw new Exception($"PayPal Auth Error: {httpResponse.StatusCode} - {jsonResponse}");
            }
        ...
        public async Task<CreateOrderResponse> CreateOrder(string value, string currency, string reference)
        {
            ...
            if (!httpResponse.IsSuccessStatusCode)
            {
                throw new Exception($"PayPal API CreateOrder Failed: {httpResponse.StatusCode} - {jsonResponse}");
            }
        ...
        public async Task<CaptureOrderResponse> CaptureOrder(string orderId)
        {
            ...
            if (!httpResponse.IsSuccessStatusCode)
            {
                throw new Exception($"PayPal API CaptureOrder Failed: {httpResponse.StatusCode} - {jsonResponse}");
            }
